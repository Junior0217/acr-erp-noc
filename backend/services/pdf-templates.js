...
.footer .qr-block .qr-text { font-size: 7.5px; color: #475569; line-height: 1.4; max-width: 280px; }
...
/* URL imprime COMPLETA con envoltura natural — el user debe poder TECLEAR
   el link desde el papel. CERO ellipsis, CERO overflow:hidden, CERO nowrap.
   overflow-wrap:break-word + word-wrap:break-word permiten wrap natural en
   espacios y separadores (slash, dash), cayendo a 2da línea limpio sin
   cortar palabras dentro del path si caben. white-space:normal restablece
   el comportamiento de wrap por defecto. */
.footer .qr-block .qr-text .qr-url  { font-family: 'SF Mono', 'JetBrains Mono', 'Consolas', monospace; color: #1e40af; font-size: 8.5px; margin-top: 2px; max-width: 280px; font-weight: 600; word-wrap: break-word; overflow-wrap: break-word; white-space: normal; line-height: 1.25; }
.footer .qr-block .qr-text .qr-url a { color: inherit; text-decoration: none; display: block; word-wrap: break-word; overflow-wrap: break-word; white-space: normal; }
